...
export type RootStackParamList = {
  Home: undefined;
  Details: { account: AccountLink };
  Redirection: { account: AccountLink };
  Success: undefined;
  Fail: undefined;
  ConnectedAccounts: undefined;
  ManageAccount: { account: AccountLink };
  DisconnectedSuccess: { account: AccountLink };
};
...
export const NeoTek = ({ theme, screen, finish }: Props) => {
  ...
  return (
    <View
      style={{
        backgroundColor: theme.themeMain.white,
        width: '100%',
        height: '100%',
      }}
    >
      <ThemeProvider theme={theme}>
        ...
        >
          <NavigationContainer>
            ...
            />
            <Stack.Navigator
              initialRouteName={screen == 'Home' ? 'Home' : 'ConnectedAccounts'}
            >
              <Stack.Screen
                name="Home"
              ...
              />
              <Stack.Screen
                name="DisconnectedSuccess"
                component={DisconnectedSuccessScreen}
                options={{ headerShown: false }}
              />
            </Stack.Navigator>
          </NavigationContainer>
