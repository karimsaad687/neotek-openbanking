import { Text, TouchableOpacity, StyleSheet,ViewStyle,FlatList, View, Image } from "react-native"
...
const ConsentPolicy = (prop: Props) => {
    ...
    return (
        <View style={[prop.style, styles.itemContainer, { backgroundColor: themeMain.gray }]}>
            <TouchableOpacity style={[styles.titleContainer, { backgroundColor: themeMain.gray }]}
