...
const TitleDetails = (prop: Props) => {
    ...
    return (
        <View style={[{ justifyContent: 'space-between',marginTop: 16, backgroundColor: themeMain.gray, borderRadius: 10, flexDirection: 'row', width: '90%', alignSelf: 'center' }]}>
            <Text style={[{ alignSelf: 'flex-start', fontFamily: fontMain.bold, color: themeMain.textPrimaryColor, paddingVertical: 8, fontSize: 17, width: '70%', marginStart: 16,textAlign:'left' }]}>
                {prop.text}
            </Text>
